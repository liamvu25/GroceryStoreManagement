<%-- 
    Document   : checkout
    Created on : Mar 07, 2022, 11:43:43 AM
    Author     : LiamVu
--%>
                ...
                <div class="col-25">
                    <form action="MainController">
                        ...
                        <c:forEach var="item" items="${sessionScope.CART.getCart()}">
                            ...
                            <input type="hidden" name="uri" value="${item.value.productID}-${item.value.productName}-${item.value.price}-${item.value.category}-${item.value.quantity}"/>
                        </c:forEach>
