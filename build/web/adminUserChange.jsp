<%-- 
    Document   : adminUserChange
    Created on : Mar 10, 2022, 10:01:26 PM
    Author     : liamvu
--%>
                ...
                <table border="1">
                    ...
                    <tbody>
                        ...
                        <form action="MainController">
                            ...
                            <td><input type="text" name="userFullName" value="${dto.userFullName}"/></td>
                            <td><input type="text" name="userAddress" value="${dto.userAddress}"/></td>
                            <td><input type="text" name="userPhone" value="${dto.userPhone}" pattern="([0-9]^*)"/></td>
                            <td>
                                <select name="newRole">                         
                            ...
                            <td><input type="text" name="password" value="${dto.userPassword}" readonly=""/></td>
                            <td>
