        ...
        <c:if test="${sessionScope.LIST_ORDERS.size() ne 0}">
            ...
            <c:if test="${sessionScope.LOGIN_USER.role eq 'ad'}">
                <form action="MainController">
                    <button name="action" value="ViewHistoryAdmin" class="btn" style="display: block;width: 100px; text-align: center">Back</button>
                </form>
            </c:if>
            <c:if test="${sessionScope.LOGIN_USER.role ne 'ad'}">  
                <form action="MainController">
                    <button name="action" value="ViewHistory" class="btn" style="display: block;width: 100px; text-align: center">Back</button>
                </form>
            </c:if>
