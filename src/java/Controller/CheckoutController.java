        ...
        try {
            ...
            if (loginUser == null) {
                ...
                for (int i = 0; i < items.length; i++) {
                    ...
                    itemsInCart.add(new ProductDTO(item[0], Integer.parseInt(item[2]), item[1], null, item[3], Integer.parseInt(item[4]), Date.valueOf(item[4]), Integer.parseInt(item[5]), null));
                }
                int orderID = -1;
