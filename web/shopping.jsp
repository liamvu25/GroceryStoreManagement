                            ...
                            <div class="col-50">
                                ...
                                <table border="1">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Status</b></td>
                                            <td>${book.status eq '1' ? "Available":"Unavailable"}</br> In storage: ${grocery.quantity}</td>
                                        </tr>
                                    ...
                                    <input type="hidden" name="importDate" value="${grocery.importDate}"/>
                                    <input type="hidden" name="usingDate" value="${grocery.usingDate}"/>
                                    <input type="hidden" name="productID" value="${grocery.productID}"/>
                                    <input class="btn" style="" type="submit" name="action" value="AddToCart"/>
                                </table>

                            </div>
                            <div class="wrapper">
                                <img class="center" src="image/${grocery.image}" style="max-height: 300px;width: 300px;display: inline-block"/>
                            </div>
                        </div>
                    </div>
                </form>
